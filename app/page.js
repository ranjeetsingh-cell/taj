		...
		<div className="app-google-rating-wrap">
			<div className="app-google-rating-inner">
				...
				<div className="rating-col">
					<span className="rating-icon"><Image src="/images/tripadvisor-icon.png" width="20" height="20" fetchPriority="high" alt="tajways Cabs"/></span>
					<div className="rating-info">
						<h3 className="rating-heading"> App Store</h3>
						<div className="star-rating-img"><Image src="/images/ratings.png" width="100" height="20" fetchPriority="high" alt="tajways Cabs"/></div>
						<div className="rating-review">(4.2K+ Reviews)</div>
					</div>
				</div>
				<div className="rating-col">
					<span className="rating-icon"><Image src="/images/google-icon.png" width="50" height="50" fetchPriority="high" alt="tajways Cabs"/></span>
					<div className="rating-info">
				...
				<div className="rating-col">
					<span className="rating-icon"><Image src="/images/playstore-icon.png" width="50" height="50" fetchPriority="high" alt="tajways Cabs"/></span>
					<div className="rating-info">
			...
			<div className="container">
				...
				<div className="why-us-items-wrap">
					<div className="why-icon-item">
						<span className="w-icon"><Image src="/images/price-transparecy.svg" width={60} height={60} fetchPriority="high" alt="tajways Cabs" /></span>
						<span className="w-txt">Price <span className="d-block">Transparency</span></span>
					</div>
					<div className="why-icon-item">
						<span className="w-icon"><Image src="/images/24-7.svg"  width={60} height={60} fetchPriority="high" alt="tajways Cabs"/></span>
						<span className="w-txt">24x7  <span className="d-block">Service</span></span>
					</div>
					<div className="why-icon-item">
						<span className="w-icon"><Image src="/images/zero-cancel.svg"  width={60} height={60} fetchPriority="high" alt="tajways Cabs"/></span>
						<span className="w-txt">Zero <span className="d-block">Cancellation</span></span>
					</div>
					<div className="why-icon-item">
						<span className="w-icon"><Image src="/images/clean-hygienic.svg"  width={60} height={60} fetchPriority="high" alt="tajways Cabs"/></span>
			...
			<div className="container">
				...
				{services.map((service, index) => (
					<div key={index} className="service-item">
						<div className="service-img"><Image src={service.image} alt={service.title}  fetchPriority="high"  loading="lazy" width={400} height={200} style={{ contentVisibility: "auto" }}  /></div>
			...
			<div className="container">
				<div className="about-inner-wrap">
					...
					<div className="about-img">
						<Image alt="Tajways" src="/images/about-bnr.jpg" width={721} height={400}  loading="lazy"  fetchPriority="low"/>
					</div>
